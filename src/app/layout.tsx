  ...
  return (
    <html lang="es">
      <head>
        ...
        <meta
          name="description"
          content="Plataforma de análisis multicriterio para proyectos de desarrollo urbano en América Latina"
        />
        ...
        <header className="navbar">
          <div className="container-urbop navbar-container">
            ...
            <nav className="navbar-links hidden md:flex">
              ...
              <Link href="/map" className={`navbar-link ${isActive('/map') ? 'active' : ''}`}>
                Explorador de Mapas
              </Link>
              <Link
                href="/projects"
              ...
              <Link href="/config" className={`navbar-link ${isActive('/config') ? 'active' : ''}`}>
                Configuración
              </Link>
            </nav>
            ...
            <div className="footer-grid">
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed max-w-md">
                  Plataforma de análisis de decisiones multicriterio para proyectos de desarrollo
                  urbano en América Latina. Transformando datos en decisiones inteligentes.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li>
                    <Link
                      href="/map"
                      className="text-gray-600 hover:text-lime-600 transition-colors flex items-center space-x-2"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
